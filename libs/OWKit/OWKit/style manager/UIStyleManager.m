...
- (UIStyleObject *)generateStyleObject:(NSDictionary *)dict
{
    ...
    for (NSString *key in dict) {
        ...
        else if ([key isEqualToString:@"button-color-selected"]) {
            style.buttonColorSelected = [OWColor colorWithHexString:(NSString *)value];
        }
        else if ([key isEqualToString:@"button-color-normal"]) {
            style.buttonColorNormal = [OWColor colorWithHexString:(NSString *)value];
        }
