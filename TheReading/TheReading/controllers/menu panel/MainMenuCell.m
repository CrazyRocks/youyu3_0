...
//    [super setSelected:selected animated:YES];
    ...
    if (selected) {
        ...
        //self.backgroundColor = [UIColor colorWithRed:34 / 255.0f green:38 / 255.0f blue:43 / 255.0f alpha:1];
        self.backgroundColor = [OWColor colorWithHexString:@"#22262B"];
    }
    else {
        iconView.image = [UIImage imageNamed:cntInfo.menuType];
        titleLB.textColor = style.fontColor;
        //self.backgroundColor = [UIColor colorWithRed:222 / 255.0f green:222 / 255.0f blue:222 / 255.0f alpha:1];
        self.backgroundColor = [OWColor colorWithHexString:@"#2B3036"];
    }
}
