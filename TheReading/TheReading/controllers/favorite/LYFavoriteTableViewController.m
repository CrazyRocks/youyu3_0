...
@interface LYFavoriteTableViewController (){
    ...
    BOOL isReloaded;
    RecommendArticleSimpleTableCellSimple *tempCell;
...
- (Class)cellClass
{
    return [RecommendArticleSimpleTableCellSimple class];
}

- (void)configCell:(RecommendArticleSimpleTableCellSimple *)cell data:(LYArticleTableCellData *)data indexPath:(NSIndexPath *)indexPath
{
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    tempCell.frame = CGRectMake(0.0f, 0.0f, CGRectGetWidth(tableView.bounds), 75);
