...
- (void)setup
{
    ...
    imgView.image = [UIImage imageNamed:@"search_page_search_button"];
    UIImageView *icon = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"search_page_search_button"]];
