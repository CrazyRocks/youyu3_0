...
.titleClass {\
margin-top: 10px;	text-align: right;margin-bottom:\ -7px;color:#8C8C8C;\
font-size:12px\
}\
</style>\
</head>\
\
<body style=\"text-align:left; padding:0px 12px 0px 12px; overflow:hidden; \
background-color:#fff; color:#000000; font-color:#000000; font-family:'FZLTXHK--GBK1-0'\">\
\
<header>\
%@ \
</header>\
