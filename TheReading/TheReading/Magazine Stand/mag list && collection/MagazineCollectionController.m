...
- (void)collectionView:(UICollectionView *)theCollectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (self.isLocalMagazine || self.isMagazineIssue) {
        ...
        /*LYMagzineDetailViewController *magDetailViewCtl = [[LYMagzineDetailViewController alloc]init];
        magDetailViewCtl.info = info;*/ //废弃掉 逻辑改版 代码重构
        ...
        [self.navigationController.navigationController pushViewController:issuesController animated:YES];
    }
}
